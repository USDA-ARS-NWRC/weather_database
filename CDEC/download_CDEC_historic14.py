...
qry = "SELECT station_id FROM tbl_stations WHERE source='CDEC' AND client = 'TUOL'"
cursor.execute(qry)
...
endTime = datetime(wy, 10, 3)
# endTime = datetime(2015,11,2,0,0,0)
startTime = datetime(wy-1, 9, 30) # start a day early to ensure that all values are grabed
