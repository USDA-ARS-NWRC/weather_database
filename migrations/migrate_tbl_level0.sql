...
declare v_max int unsigned default 35678415;
declare v_counter int unsigned default 0;

  while v_counter < v_max do
	start transaction;
    	SELECT v_counter;
	INSERT INTO weather_db.tbl_level0 (station_id,date_time,air_temp,dew_point_temperature,relative_humidity,wind_speed,wind_direction,wind_gust,solar_radiation,snow_smoothed,precip_accum,snow_depth,snow_interval,snow_water_equiv,vapor_pressure,cloud_factor)
	SELECT 
		station_id,
		date_time,
		air_temp,
