...
ALTER TABLE tbl_level1 ADD COLUMN av_del TINYINT(1) DEFAULT 0;


-- tbl_level1 is the automatic data QC and organization
CREATE TABLE IF NOT EXISTS tbl_level1_5 LIKE tbl_raw_data;
ALTER TABLE tbl_level1_5 ADD COLUMN clipped TINYINT(1) DEFAULT 0;


-- tbl_level2 is the users accessing the db and changing the data
CREATE TABLE IF NOT EXISTS tbl_level2 LIKE tbl_raw_data;

ALTER TABLE tbl_level2 ADD COLUMN user VARCHAR(20) FIRST,
ADD COLUMN date_fixed DATETIME AFTER user;

ALTER TABLE tbl_level2 ADD COLUMN precip_intensity DECIMAL(10,5) AFTER precip_accum;
